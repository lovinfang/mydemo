$(function(){
    //创建一级菜单
    var obj = getContentArray("mybank_credit_supplychain_trade_cancel");
    ...
    function createSecondSubject(){
        ...
        if(needCreate != undefined){
            ...
            for(var i=0;i<arr.length;i++){
                var obj = getSubContentArray("mybank_credit_supplychain_trade_cancel",arr[i]);
...
var need_create_content="buyer";

var mybank_credit_supplychain_trade_cancel="trade_type|request_id|buyer|sale_pd_code|out_order_no|channel";
var mybank_credit_supplychain_trade_cancel_detail = {
...
var mybank_credit_supplychain_trade_cancel_defaultvalue = {
    "request_id":"IPROLEID_DATEFORMAT_RANDOM8"
}

var mybank_credit_supplychain_trade_cancel_buyer="use_type|ip_id|ip_role_id|site|site_user_id|site_login_id";
var mybank_credit_supplychain_trade_cancel_buyer_detail = {
