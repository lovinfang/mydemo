$(function(){
    //创建一级菜单
    var obj = getContentArray("trade_create_event");
    createTable(null,obj,"contentBody");
    $("body").on("click","#jsonStyle",onCrtJsonClick);
});

var trade_create_event ="request_id|dataOrgId|ipId|ipRoleId|outOrderNo|success|tradeAmount";
var trade_create_event_detail = {
    request_id:"幂等流水号",
...
var trade_create_event_defaultvalue = {
...
function createJsonOnblur() {
    ...
    if(str == ""){
        ...
        try{
            ...
            $("#tradeAmount").val(bizContent.trade_amount);
