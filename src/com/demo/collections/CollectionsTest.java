...
public class CollectionsTest {
    ...
    public static void test(ArrayList<Integer> arrayList){
        ...
        System.out.println("Collections.reverse(arrayList)---反转");
        System.out.println(arrayList);
        ...
        System.out.println("Collections.sort(arrayList):自然参数升序");
        System.out.println(arrayList);

        // void shuffle(List list),随机排序
        Collections.shuffle(arrayList);
        System.out.println("Collections.shuffle(arrayList):随机排序");
        System.out.println(arrayList);

        // void swap(List list, int i , int j),交换两个索引位置的元素  是下标为 i 和 j的两个元素
     ...
     */
    public static void test2(ArrayList<Integer> arrayList,ArrayList<Integer> arrayList2){
        System.out.println("原始数组:");
        System.out.println(arrayList);

        System.out.print("Collections.max(arrayList)最大值为:");
        System.out.println(Collections.max(arrayList));

        System.out.print("Collections.min(arrayList):最小值为");
        System.out.println(Collections.min(arrayList));

        System.out.println("Collections.replaceAll(arrayList, 3, -3):将list中的3修改为-3");
        Collections.replaceAll(arrayList, 3, -3);
        System.out.println(arrayList);

        System.out.print("Collections.frequency(arrayList, -3):出现次数为");
...
//        Collections.sort(arrayList);
    ...
    public static void main(String[] args) {
        ...
        arrayList.add(-9);
        arrayList.add(-7);
//        CollectionsTest.test(arrayList);

        ArrayList<Integer> arrayList2 = new ArrayList<Integer>();
        arrayList2.add(-3);
        arrayList2.add(-5);
        arrayList2.add(7);
//        CollectionsTest.test2(arrayList,arrayList2);

        CollectionsTest.test3(arrayList);
    }
}
